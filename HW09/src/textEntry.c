...
void resetVariables()
{
	...
	theTime = 0;
	vblankcount = 0;
	play = FALSE;   // When set to TRUE tells us to start beep
	playBG = FALSE; // This tell us if the BG is supposed to be playing
	BGplaying = FALSE; // This tells us if it is playing
}
